        ...
        <v-flex xs12 md12 lg12 xl12>
            <v-layout class="m-0 mt-3">
                ...
                <v-flex class="px-3 m-design-input position-relative" md3 lg3 xl3 xs3 sm3>
                    <input class="form-control-sm input-wager" type="text" v-model="data.transport.tonnage" required>
                    <span class="bar"></span>
                    <label>Грузоподъемность</label>
                    <div class="select" id="unit-cars">
                        <select v-model="data.transport.measure">
                            <option value="тн." selected>тн.</option>
                ...
                <v-flex class="px-3" md3 lg3 xl3 xs3 sm3>
                    <v-select
                        v-model="data.transport.carcass"
                        :items="optionLoading"
                        :menu-props="{ maxHeight: '300' }"
                        label="Вид загрузки"
                        class="m-0 p-0 cars-options"
    ...
    export default {
        ...
        methods: {
            send() {
                ...
                this.$store.dispatch('ADD_ADVERT', this.data);
